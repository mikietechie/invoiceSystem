                    ...
                    <form onSubmit={this.handleFormSubmit} id="editCustomerForm" name="editCustomerForm">
                        ...
                        <div className="form-group row">
                            ...
                            <div className="col-sm-6">
                                <input type="text" name="name" id="editCustomerName" className="form-control" placeholder="Mike Micheals" value={this.state.name} onChange={this.handleInputChange} />
                            </div>
                        </div>
                        <div className="form-group row">
                            <label className="col-sm-6 col-form-label">Email</label>
                            <div className="col-sm-6">
                                <input type="text" name="email" id="editCustomerEmail" className="form-control" placeholder="mm@mail.com" value={this.state.email} onChange={this.handleInputChange} />
                            </div>
                        </div>
                        <div className="form-group row">
                            <label className="col-sm-6 col-form-label">Phone</label>
                            <div className="col-sm-6">
                                <input type="text" name="phone" id="editCustomerPhone" className="form-control" placeholder="+263771588144" value={this.state.phone} onChange={this.handleInputChange} />
                            </div>
                        </div>
                        <div className="form-group row">
                            <label className="col-sm-6 col-form-label">Address</label>
                            <div className="col-sm-6">
                                <textarea name="address" id="editCustomerAddress" className="form-control" placeholder="Stand # 11 Lorraine Drive, Bluffhill, Harare" value={this.state.address} onChange={this.handleInputChange}></textarea>
                            </div>
                        </div>
                        <div className="form-group row">
